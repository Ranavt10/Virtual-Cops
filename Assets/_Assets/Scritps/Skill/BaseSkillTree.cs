...
public class BaseSkillTree : MonoBehaviour
{
    ...
    {
        PlayerRamboSkillData skillProgress = GameDataNEW.playerRamboSkills.GetRamboSkillProgress(ramboId);
        ...
        if (skillProgress != null)
        {
            for (int i = 0; i < skills.Length; i++)
            {
                ...
                StaticRamboSkillData skillData = GameDataNEW.staticRamboSkillData.GetData(skill.id);
