...
public class DailyQuestTracker : MonoBehaviour
{
    ...
    {
        if (GameDataNEW.playerDailyQuests.Count <= 0)
        {
            RefreshDailyQuest();
        }
        else
        {
            ...
            {
                PlayerDailyQuestData questData = GameDataNEW.playerDailyQuests[i];
    ...
    private void RefreshDailyQuest()
    {
        ...
        quests.Clear();
        GameDataNEW.playerDailyQuests.Clear();
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            quests.Add(quest);
            GameDataNEW.playerDailyQuests.Add(new PlayerDailyQuestData(quest.type));
