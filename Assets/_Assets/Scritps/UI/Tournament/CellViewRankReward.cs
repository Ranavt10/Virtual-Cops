...
public class CellViewRankReward : MonoBehaviour
{
    ...
    public void Load()
    {
        StaticTournamentRankData staticData = GameDataNEW.staticTournamentRankData.GetData((int)rankType);
    ...
    {
        bool canClaim = false;
        TournamentRank playerRank = GameDataNEW.staticTournamentRankData.GetCurrentRank(GameDataNEW.playerTournamentData.score);
