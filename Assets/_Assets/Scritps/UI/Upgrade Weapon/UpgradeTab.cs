            ...
            case WeaponTab.Rifle:
                {
                    ...
                    {
                        if (gun.Value.isNew && GameDataNEW.staticGunData[gun.Key].isSpecialGun == false)
                        {
                            hasNewRifle = true;
                            break;
                        }
            ...
            case WeaponTab.Special:
                {
                    ...
                    foreach (KeyValuePair<int, PlayerGunData> gun in GameDataNEW.playerGuns)
                    {
                        if (gun.Value.isNew && GameDataNEW.staticGunData[gun.Key].isSpecialGun)
                        {
                            hasNewSpecial = true;
                            break;
                        }
            ...
            case WeaponTab.Grenade:
                {
                    ...
                    foreach (KeyValuePair<int, PlayerGrenadeData> grenade in GameDataNEW.playerGrenades)
                    {
            ...
            case WeaponTab.MeleeWeapon:
                {
                    ...
                    foreach (KeyValuePair<int, PlayerMeleeWeaponData> meleeWeapon in GameDataNEW.playerMeleeWeapons)
                    {
