...
public class _StaticAchievementData : List<StaticAchievementData>
{
    ...
    public void SortByState()
    {
        for (int i = 0; i < Count; i++)
        {
            ...
            int progress = GameDataNEW.playerAchievements.ContainsKey(staticData.type) ?
                GameDataNEW.playerAchievements[staticData.type].progress : 0;

            int target = milestone.requirement;

            staticData.isCompleted = GameDataNEW.playerAchievements.ContainsKey(staticData.type) ?
