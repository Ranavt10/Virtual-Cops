...
public class _PlayerAchievementData : Dictionary<AchievementType, PlayerAchievementData>
{
    ...
    public int GetNumberReadyAchievement()
    {
        ...
        {
            StaticAchievementData staticData = GameDataNEW.staticAchievementData.GetData(achievement.type);
    ...
    {
        StaticAchievementData staticData = GameDataNEW.staticAchievementData.GetData(type);
