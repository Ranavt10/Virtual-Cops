...
public class Map : MonoBehaviour
{
    ...
    //{
    //    if (GameDataNEW.currentStage.difficulty == Difficulty.Normal)
    //        return;
    ...
    {
        CoinCompleteStage = GameDataNEW.staticCampaignStageData.GetCoinCompleteStage(GameDataNEW.currentStage.id, GameDataNEW.currentStage.difficulty);

        if (mapData.enemyData == null)
            return;

        int coinFromEnemy = GameDataNEW.staticCampaignStageData.GetCoinDrop(GameDataNEW.currentStage.id, GameDataNEW.currentStage.difficulty);
