...
public class LabDoorSpawnEnemy : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            int coin = GameDataNEW.staticCampaignStageData.GetCoinDrop(GameDataNEW.currentStage.id, GameDataNEW.currentStage.difficulty);
    ...
    private void SpawnUnit()
    {
        ...
        if (GameDataNEW.mode == GameMode.Campaign)
        {
            ...
            //if (GameDataNEW.currentStage.difficulty == Difficulty.Hard)
            //{
            //    level += StaticValue.LEVEL_INCREASE_MODE_HARD;
            //}
            //else if (GameDataNEW.currentStage.difficulty == Difficulty.Crazy)
            //{
