...
namespace NativeGalleryNamespace
{
	...
	public class Settings
	{
		...
		public static void PreferencesGUI()
		{
			...
			Instance.DontAskLimitedPhotosPermissionAutomaticallyOnIos14 = EditorGUILayout.Toggle( new GUIContent( "Don't Ask Limited Photos Permission Automatically", "See: . It's recommended to keep this setting enabled" ), Instance.DontAskLimitedPhotosPermissionAutomaticallyOnIos14 );
